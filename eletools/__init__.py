...
__all__ = [ "elephant","pedigree","measure","event",
            ...
            "matriline_tree","nexus_tree","censor_elephant", "fuzzy_match_measure","analyse_calf","relatedness_matrix","regularise_calf_names",
...
from eletools.Tools import matriline_tree, nexus_tree, censor_elephant, fuzzy_match_measure, analyse_calf, relatedness_matrix, regularise_calf_names
